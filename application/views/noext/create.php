...
<body>
	...
	<div class="page-container">
		...
		<li class="navigation-header active"><span></span> <i class="icon-menu" title="Tables"></i><a href="http://tika.tehsipp.com/index.php/noext/create">Tambah</a></li>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							<form class="form-horizontal" method="POST" action="http://tika.tehsipp.com/index.php/noext/create">
								<fieldset class="content-group">
									...
									<div class="form-group">
										<label class="control-label col-lg-2">NomerHP</label>
										<div class="col-lg-10">
